...
class VoiceChatbot:
    def __init__(self):
        self.cohere = cohere.Client("bMr7IkNYvhIArEDPdxdl86EJyT5SRTx93QnxcZZc")  # Replace with your actual Cohere API key
        self.elevenlabs = ElevenLabs(api_key="sk_a60c33c92339241a391bd9c3f819cce02d349111ac9350ae")  # Replace with your actual ElevenLabs API key
    ...
    def think(self, text):
        response = self.cohere.chat(model="command-r7b-arabic-02-2025",message=text,temperature=0.7,max_tokens=200, preamble="جاوب بلهجة سعودية فقط، جاوب بشكل مختصر، اسمك هو المساعد الذكي وقد صممك براء الجعوري")
